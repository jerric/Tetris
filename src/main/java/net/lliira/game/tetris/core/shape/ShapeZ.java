...
public class ShapeZ extends Shape {
  private static final Point[] H_BLOCKS = new Point[] {P(0, 0), P(1, 0), P(1, 1), P(2, 1)};
  private static final Point[] V_BLOCKS = new Point[] {P(1, 0), P(0, 1), P(1, 1), P(0, 2)};

  public ShapeZ(Orientation orientation) {
    super(orientation);
  }
